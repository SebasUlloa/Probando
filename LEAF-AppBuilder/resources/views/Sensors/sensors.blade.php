...
<div class="btn-group">
  ...
  <a href="{{ route('sensors')}}" class="btn btn-success active">Sensores</a>
...
<h1 class="mt-3">Sensores de Lectura</h1>
<hr/>
<form action="{{ route('hasfullsensors') }}" method="post">
    @csrf
    <div class="mb-3">
    <div class="col-sm-8">
    <br/>      
    ...
    <button type="submit" value="{{ route('hasfullsensors') }}" class="btn btn-primary">Siguiente</button>
</form>
@stop
